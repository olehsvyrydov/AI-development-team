...
> during the transition — **edit the skill first and mirror it here**, or the two will drift into
> two answers to the same question. This file goes away when `install.sh` is retired.
